...
const App = () => {
  ...
  return (
    ...
    <div className='h-screen lg:flex gap-1'>
      ...
      <div className='flex flex-col gap-5 lg:border-l-2 lg:w-1/2 m-5'>
        ...
        <div className='flex flex-wrap h-full overflow-auto'>
          {task.map(function (elem, idx) {
            return <div key={idx} className='w-70 h-80 bg-[url(https://media.istockphoto.com/id/185245773/photo/a-blank-black-noted-book-on-a-white-background.jpg?s=612x612&w=0&k=20&c=saLTbbLpwy6f11xF858ab1Uchrk4BJfUg9vPqhauRg0=)] bg-cover  p-10 flex flex-col justify-between '>
